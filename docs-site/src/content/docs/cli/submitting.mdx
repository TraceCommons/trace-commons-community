...
Logout deletes the local contributor configuration, device key, receipts, and orphaned temporary files. It is not a substitute for revoking already submitted traces.
