...
The response can include current status, pending and final credit, delayed-credit ledger totals, safe explanations, and the recorded consent scopes. See [What happens after submission](/start/after-submission/) for the full lifecycle.
